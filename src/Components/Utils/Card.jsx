...
function Card({data}) {
    ...
    return (
        <div class="w-full overflow-hidden shadow-lg p-5 rounded-2xl">
            <Img imgDesign={imgDesign} getImg={img}/>
            <div class="py-4 md:py-5 mb-3 md:mb-4 border-b-2 border-gray-200">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <Button btnDesign={btnDesign}>Choose Player</Button>
                </div>
